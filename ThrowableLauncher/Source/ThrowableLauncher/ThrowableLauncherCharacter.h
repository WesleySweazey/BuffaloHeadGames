...
#include "ThrowableLauncherCharacter.generated.h"
...
UCLASS(config=Game)
class AThrowableLauncherCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AThrowableLauncherProjectile> ProjectileClass;
